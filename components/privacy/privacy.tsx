...
const Privacy = () => {
  return (
    <div className={styles.container}>
      ...
      <p>
        Codelloy built the letterite app as a Freemium app. This SERVICE is
        provided by Codelloy at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at letterite unless otherwise
      ...
      <p>
        ...
        but not limited to address, phone number, email . The information that I
      ...
      <p>This policy is effective as of 2022-02-17</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at support@letterite.com.
      </p>{" "}
      <p>
