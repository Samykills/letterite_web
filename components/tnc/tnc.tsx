  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        ...
        not continue to use Letterite if you do not agree to take all of the
      ...
      <p>
        Unless otherwise stated, Letterite and/or its licensors own the
        intellectual property rights for all material on Letterite. All
        intellectual property rights are reserved. You may access this from
        Letterite for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Letterite</li>
        <li>Sell, rent or sub-license material from Letterite</li>
        <li>Reproduce, duplicate or copy material from Letterite</li>
        <li>Redistribute content from Letterite</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this app offer an opportunity for users to post and exchange
        opinions and information in certain areas of the website. Letterite does
        ...
        Letterite, its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Letterite shall not be liable for the
      ...
      <p>
        Letterite reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Letterite a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Letterite; and (d) the link is
      ...
      <p>
        ...
        e-mail to Letterite. Please include your name, your organization name,
      ...
      <p>
        No use of Letterite's logo or other artwork will be allowed for linking
